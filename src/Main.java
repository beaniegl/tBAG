...
public class Main {
	...
	private static Skeleton skeleton = new Skeleton("", "", 10, 7);

	private static FinalBoss fb = new FinalBoss("", "", 20, 20);

	public static void gameSetup() {

		Item sword = new Item("Sword", "This is a long sword which gives +1 attack.");
		Item potion = new Item("Potion", "This warm potion gives you +20 health");
		Item axe = new Item("Axe", "This heavy axe gives +1 attack.");
		...
		Room r4 = new Room("Dungeon",
				...
				2, Direction.NOEXIT, 4, Direction.NOEXIT, potion);
		Room r5 = new Room("Void",
				...
				Direction.NOEXIT, Direction.NOEXIT, Direction.NOEXIT, 3, axe);
		...
		if (Character.getRoom().getName().equals("Void")) {
			...
			while (skeleton.getHealth() > 0 || warrior.getHealth() > 0) {
				...
				if (command.equals("flee")) {
					...
					System.out.println("The enemy now has: " + skeleton.getHealth() + " health.");
	...
	public static void applyItem(Item aItem) {
		if (aItem.getName().equals("Sword") || aItem.getName().equals("Axe")) {
	...
	public static void gameLoop() {
		...
		while (warrior.getHealth() > 0 && gameOver == false) {
			...
			if (command.equals("explore")) {
				...
				applyItem(temp);
				System.out.println("You added a: " + temp.getName() + " to your inventory!");
